    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mycourses.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(Reminders.this, CoursesList.class);
        ...
        newsfeed.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(Reminders.this, NewsFeed.class);
                startActivity(intent);
            }
        });
        ...
        addpeople.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(Reminders.this, AddPeople.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.Signout:
                ...
                ParseUser.logOut();
                Intent signin = new Intent(this, LogIn_Activity.class);
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public  class VerticalItemHolder extends SwappingHolder
            ...
            public boolean onLongClick(View v) {
                AppCompatActivity activity = Reminders.this;
